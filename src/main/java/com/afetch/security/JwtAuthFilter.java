...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private final AfetchUserDetailsService userDetailsService;

    public JwtAuthFilter(JwtTokenProvider jwtTokenProvider, AfetchUserDetailsService userDetailsService) {
